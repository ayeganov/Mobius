...
_STATEID = _descriptor.EnumDescriptor(
  name='StateId',
  full_name='base.StateId',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='RESULT', index=0, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPLOADING', index=2, number=3,
      options=None,
      type=None),
  ],
...
_WORKERSTATE = _descriptor.Descriptor(
  name='WorkerState',
  full_name='base.WorkerState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='state_id', full_name='base.WorkerState.state_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='response', full_name='base.WorkerState.response', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode(b(""), "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='error', full_name='base.WorkerState.error', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode(b(""), "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
